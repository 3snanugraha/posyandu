      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              ...
              <div class="card info-card customers-card rounded-4">
                ...
                <div class="card-body">
                  <h5 class="card-title">Laporan <span>| Data Laporan</span></h5>
            ...
            <div class="col-12">
              <div class="card rounded-4">
                ...
                <div class="card-body">
                  <h5 class="card-title">Laporan Statistik <span>/ Semua</span></h5>
        ...
        <div class="col-lg-4">
          ...
          <div class="card rounded-4">
            ...
            <div class="card-body">
              <h5 class="card-title">Data Terbaru <span>| Riwayat</span></h5>
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Admin menambahkan <a href="#" class="fw-bold text-dark">1 Data</a> Terbaru
                  </div>
          ...
          <!-- <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Statistik Lain <span>| This Month</span></h5>
          ...
          <div class="card rounded-4">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Berita &amp; Terbaru <span>| Sekarang</span></h5>
