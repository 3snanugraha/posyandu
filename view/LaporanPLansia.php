...
<?php include "Navigation.php"; ?>
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Pemeriksaan Lansia Semua Periode</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active">L. Pemeriksaan Lansia Semua Periode</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card rounded-4">
            <div class="card-body">
              <h5 class="card-title">Laporan Pemeriksaan Lansia Semua Periode </h5>
              <p>Berikut adalah semua laporan pemeriksaan data Lansia gunakan <code>.Search </code> untuk mencari atau memfilter data. gunakan button <code>.Cetak </code> untuk mencetak data berdasarkan range tanggal.</p>
              <a href="#" data-bs-toggle="modal" data-bs-target="#cetak-laporan-lansia" class="btn btn-outline-primary mt-2 mb-4 rounded-pill"><i class="bi bi-printer"></i><span> Cetak Laporan</span></a>
